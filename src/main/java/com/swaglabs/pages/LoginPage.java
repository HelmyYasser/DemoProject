...
public class LoginPage {
    ...
    public LoginPage assertCurrentUrl() {
        CustomSoftAssertion.softAssertion.assertEquals(BrowserActions.getCurrentUrl(driver),
                getPropertyValue("homeURL"), "Current URL does not match expected.");
        return this;
    }
    ...
    public LoginPage assertLoginPageTitle() {
        CustomSoftAssertion.softAssertion.assertEquals(BrowserActions.getPageTitle(driver),
                getPropertyValue("appTitle"), "Login page title does not match expected.");
        return this;
    }
    ...
    public LoginPage isLoginUnsuccessful() {
        Validations.validateEquals(getErrorMessage(), getPropertyValue("errorMessage"),
